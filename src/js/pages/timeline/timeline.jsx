    ...
    <>
      <ul class="timeline">
        <li class="timeline-item">
          <h2 class="timeline-item-title">2016: SpaceX announced plans to fly its earliest missions to Mars.</h2>
        ...
        <li class="timeline-item">
          ...
          <p class="timeline-item-text">
            Since 2016, SpaceX publicly announced a comprehensive vision to begin the colonization of Mars, by proposing
            to develop a high-capacity timeline infrastructure.
          </p>
        </li>
        <li class="timeline-item">
        ...
        <li class="timeline-item">
          ...
          <p class="timeline-item-text">
            The objectives for the first mission will be to confirm water resources, identify hazards, and put in place
            initial power, mining, and life support infrastructure.
          </p>
        </li>
        <li class="timeline-item">
          <h2 class="timeline-item-title">2023: Private lunar mission.</h2>
          <p class="timeline-item-text">
            On September 17, 2018, SpaceX announced fashion innovator and globally recognized art curator Yusaku Maezawa
            will be the company’s first private passenger to fly around the Moon in 2023.
          </p>
        </li>
        <li class="timeline-item">
